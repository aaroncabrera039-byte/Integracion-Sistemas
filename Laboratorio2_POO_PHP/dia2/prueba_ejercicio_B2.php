...
verificar(
    "La biblioteca nace vacía (contarLibros() === 0)",
    $b->contarLibros() === 0
);
...
verificar(
    "contarLibros() registra 2 tras agregar 2 libros",
    $b->contarLibros() === 2
);

verificar(
    "listarTitulos() retorna los títulos en el orden correspondiente",
    $b->listarTitulos() === ["Clean Code", "Refactoring"]
);
