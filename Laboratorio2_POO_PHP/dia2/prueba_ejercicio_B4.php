...
verificar(
    "imprimirTodos() imprime la línea correspondiente a la factura",
    str_contains($salida, "002")
);

verificar(
    "imprimirTodos() imprime la línea correspondiente al recibo",
    str_contains($salida, "099")
);

verificar(
    "imprimirTodos() no genera error con un objeto que no implementa Imprimible",
    true
);
