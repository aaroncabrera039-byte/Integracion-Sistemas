...
verificar(
    "El empleado base calcula el pago igual al salario base",
    $ana->calcularPago() === 500.0
);

$kevin = new EmpleadoComision("Kevin", 500, 150);

verificar(
    "EmpleadoComision suma salario base y comisión",
    $kevin->calcularPago() === 650.0
);

verificar(
    "EmpleadoComision ES-UN Empleado (herencia)",
    $kevin instanceof Empleado
);
