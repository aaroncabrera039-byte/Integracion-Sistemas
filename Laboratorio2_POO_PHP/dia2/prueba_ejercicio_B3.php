...
verificar(
    "getNombre() retorna el nombre correctamente heredado",
    $est->getNombre() === "Kevin Martínez"
);

verificar(
    "getCarnet() retorna el número de carné correctamente",
    $est->getCarnet() === "2026-ISC-0198"
);

$reflexion = new ReflectionClass('Persona');

verificar(
    "La propiedad \$nombre en Persona es protected (no private)",
    $reflexion->getProperty('nombre')->isProtected()
);
