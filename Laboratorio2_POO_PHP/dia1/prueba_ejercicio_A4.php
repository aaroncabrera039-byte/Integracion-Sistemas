...
verificar(
    "Después de depositar 150.50, el saldo es 150.50",
    $c->getSaldo() === 150.50
);
...
verificar(
    "depositar() rechaza montos negativos o cero mediante una excepción",
    $excepcionLanzada
);

verificar(
    "El saldo no se modifica tras el intento inválido",
    $c->getSaldo() === 150.50
);
