...
verificar(
    "aplicarDescuento(20) deja el precio en 80.0",
    round($prod->getPrecio(), 2) === 80.0
);
...
verificar(
    "aplicarDescuento(150) lanza una excepción (fuera de rango)",
    $excepcion
);
...
verificar(
    "aplicarDescuento(-5) también lanza una excepción",
    $excepcion2
);
