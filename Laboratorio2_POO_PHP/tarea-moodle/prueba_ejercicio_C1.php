...
verificar(
    "La columna nace vacía (contarTareas() === 0)",
    $columna->contarTareas() === 0
);

$columna->agregarTarea(new Tarea("Tarea A"));

verificar(
    "Con 1 de 2 tareas, estaLlena() debe ser false",
    $columna->estaLlena() === false
);

$columna->agregarTarea(new Tarea("Tarea B"));

verificar(
    "Con 2 de 2 tareas, estaLlena() debe ser true",
...
verificar(
    "El tablero contabiliza correctamente las tareas totales",
