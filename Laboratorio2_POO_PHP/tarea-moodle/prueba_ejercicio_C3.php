...
verificar(
    ...
    $t1 instanceof \App\Contracts\Comentable
);

verificar(
    "t1 recibió el comentario correspondiente",
    $t1->getComentarios() === ["Revisado por el equipo"]
);

verificar(
    "t2 también recibió el comentario correspondiente",
    $t2->getComentarios() === ["Revisado por el equipo"]
);
