...
verificar(
    "getEtiquetas() retorna exactamente 2 etiquetas (sin duplicados)",
    count($t->getEtiquetas()) === 2
);

verificar(
    "Las etiquetas corresponden a ['backend','urgente']",
    $t->getEtiquetas() === ['backend', 'urgente']
);

verificar(
    "TareaConEtiquetas ES-UNA Tarea (herencia)",
    $t instanceof \App\Models\Tarea
);
